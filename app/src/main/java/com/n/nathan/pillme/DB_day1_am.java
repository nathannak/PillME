...
public class DB_day1_am extends SQLiteOpenHelper  {

    private static final int DATABASE_VERSION = 1;
    private static final String DATABASE_NAME = "med_1_amDB.db";
    private static final String TABLE_MED_1_AM = "med_1_am";
    ...
    public DB_day1_am(Context context, SQLiteDatabase.CursorFactory factory)
    {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String CREATE_TABLE_MED_1_AM = "CREATE TABLE IF NOT EXISTS " +
                TABLE_MED_1_AM + "("
                + COLUMN_SYMBOL +
                " TEXT , "
                + COLUMN_NAME +
        ...
        db.execSQL(CREATE_TABLE_MED_1_AM);
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion,
                          int newVersion) {
        db.execSQL("DROP TABLE IF EXISTS " + TABLE_MED_1_AM);
        onCreate(db);
    }
    ...
    public void addMeds() {
        ...
        //
        Log.v("DB_day1_am","numberOfRecords before function: " + number_of_records() );

        deleteAllRec();

        Log.v("DB_day1_am","numberOfRecords after function: " + number_of_records() );
        //

        //
        SharedPreferences pref  = ctx.getSharedPreferences("day1-am",Context.MODE_PRIVATE);
        //
        ...
        for( int i=1 ; i<6 ; i++ ) {
            ...
            Log.v("DB_day1_am", "saved med" + i + " symbol " + pref.getString("med"+i+"-symbol", null) );
            ...
            Log.v("DB_day1_am", " minute value for med " + i + " is: " + Integer.toString(pref.getInt("med"+i+"-minute", 0) ));

            values.put(COLUMN_HASALARMIMAGE, Boolean.toString(pref.getBoolean("med"+i+"-alarm",false)) );
            Log.v("DB_day1_am", "saved alarm boolean value:" + Boolean.toString(pref.getBoolean("med"+i+"-alarm",false))  , null );
            ...
            db.insert(TABLE_MED_1_AM, null, values);
            ...
            //
            Log.v("DB_day1_am", number_of_records() + " is number of records in DB_day1_am after save");
            //
    ...
    public void loadMeds()
    {
        ...
        //
        //String query = "Select * FROM " + TABLE_MED_1_AM + " WHERE " + COLUMN_ID + " =  \"" + id + "\" ORDER BY " + COLUMN_ORDER + " DESC";
        String query = "SELECT * FROM " + TABLE_MED_1_AM;
        //
        ...
        Log.v("DB_day1_am", " number of records in day1-am DB: " + cnt );
        //

        SharedPreferences.Editor pref = ctx.getSharedPreferences("day1-am",Context.MODE_PRIVATE).edit();
        ...
        Log.v("DB_day1_am","cursor.getString(0) after cursor.moveToFirst is: " + cursor.getString(0)) ;
        //

        //
        pref.putString("med1-symbol",cursor.getString(0));
        Log.v("DB_day1_am", " loaded med1-symbol " + cursor.getString(0) );
        //
        ...
        Log.v("DB_day1_am", "minute value for med1 is: " + Integer.parseInt(cursor.getString(3)));
        //
        pref.putBoolean("med1-alarm",Boolean.parseBoolean(cursor.getString(4) ));
        Log.v("DB_day1_am", " Boolean value for loaded med1-alarm " + cursor.getString(4) );
        //
        ...
        for(int i=2; i<6; i++){
            ...
            if (cursor.moveToNext()){
                ...
                Log.v("DB_day1_am", " loaded med"+i+"-symbol is: " + cursor.getString(0) );
                //
                ...
                Log.v("DB_day1_am", "minute value for med" + i + " is: " + Integer.parseInt(cursor.getString(3)));
                //
                pref.putBoolean("med"+i+"-alarm",Boolean.parseBoolean(cursor.getString(4) ));
                Log.v("DB_day1_am", " loaded med"+i+"-alarm is: " + cursor.getString(4) );
                //
...
//
    ...
    public void deleteAllRec()
    {
        ...
        SQLiteDatabase db = this.getWritableDatabase();
        db.execSQL("DELETE FROM " +  TABLE_MED_1_AM); // + " WHERE " + COLUMN_NAME + " IN (SELECT " +  COLUMN_NAME + " FROM " +  TABLE_MED_1_AM + " ORDER BY " +  COLUMN_NAME + " ASC LIMIT 5)");
        db.close();

//     //   db.execSQL("DELETE FROM " +  TABLE_MED_1_AM + " WHERE " + COLUMN_NAME + " IN (SELECT " +  COLUMN_NAME + " FROM " +  TABLE_MED_1_AM + " ORDER BY " +  COLUMN_NAME + " ASC LIMIT 5)");

//        String query =  "DELETE FROM " + TABLE_MED_1_AM +  " WHERE " + COLUMN_SYMBOL + " IN (SELECT " +  COLUMN_SYMBOL + " FROM " +  TABLE_MED_1_AM + " LIMIT 5)";
